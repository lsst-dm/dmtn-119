...
It was noted that because the rehearsal was using a processing \gls{pipeline} (and \gls{QA} tools) more amenable to \gls{Data Release Processing} (\gls{DRP}) and that \gls{QA} products available might not be good comparisons to that needed when working with prompt processing.  
